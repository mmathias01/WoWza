	...
	["namespaces"] = {
		...
		["EditboxHistory"] = {
			["char"] = {
				["Majandra - Dragonblight"] = {
					["history"] = {
						"/raid start summons with the throne summoning stone if you would please", -- [1]
						"/invite Makeena", -- [2]
						"/raid we got people at the stone yet?", -- [3]
						"/raid im omw back either way", -- [4]
						"/raid summons should be coming shortly, standby ;)", -- [5]
						"/raid we can do it with this - but anyone is welcome obvs", -- [6]
						"/cw Stabbzx we got people @ stone yet?", -- [7]
						"/raid working on it - using the stone @ ToT", -- [8]
						"/raid summons are going out so should get it soon ;)", -- [9]
						"/raid oh yah and dont do that rofl", -- [10]
						"/raid summon spit", -- [11]
						"/raid so he can summon to boss ;)", -- [12]
						"/raid anyone still need summon?", -- [13]
						"/cw Dariar crafting mat for 496 gear", -- [14]
						"/cw Dariar keep it they are valuable", -- [15]
						"/raid thanks all", -- [16]
						...
						"/friend Dariar", -- [20]
						"/raid thanks all", -- [21]
						"/g lol not bad for only 3 healers", -- [22]
						"/cw Dariar not bad for 3 healers lol", -- [23]
						"/g thanks guys", -- [24]
						"/friend Dariar", -- [25]
						"/g good evening all", -- [26]
						"/s np", -- [27]
