	...
	["namespaces"] = {
		...
		["EditboxHistory"] = {
			["char"] = {
				["Majandra - Dragonblight"] = {
					["history"] = {
						"/cw Horriddream-Ner'zhul if we have to we can dps through it", -- [1]
						"/cw Horriddream-Ner'zhul just get more axes", -- [2]
						"/cw Horriddream-Ner'zhul but we had zillions of those anyhow so meh", -- [3]
						"/cw Horriddream-Ner'zhul my guess is that since LFR doesnt punish people as much for standing in shit that blizzard assumed people would DPS through defensive", -- [4]
						"/cw Horriddream-Ner'zhul no doubt", -- [5]
						"/cw Horriddream-Ner'zhul but this fucker has my shitty trinket", -- [6]
						"/cw Horriddream-Ner'zhul and I want to take it from him but I need these 23 other people to help out", -- [7]
						"/i also kill the shaman FIRST FIRST", -- [8]
						"/i they WILL heal the boss", -- [9]
						"/i and we CANNOT have that", -- [10]
						"/i pop hero during BEZERKER phase", -- [11]
						"/i he takes 20% more damage", -- [12]
						"/i 20% more damage == better hero", -- [13]
						"/cw Horriddream-Ner'zhul watch the enrage, if it is going to be close - let people go through defensive stance", -- [14]
						"/cw Horriddream-Ner'zhul I knew it was a wipe at 4min on the timer", -- [15]
						"/i stick with it guys that was better at least", -- [16]
						"/i and we got another stack", -- [17]
						"/i so we are that much better now ;)", -- [18]
						"/i super determined", -- [19]
						"/cw Horriddream-Ner'zhul yay I beat a shadow priest", -- [20]
						"/cw Horriddream-Ner'zhul maybe we boost the dps by wiping to this naked 3 or 4 times", -- [21]
						"/cw Horriddream-Ner'zhul I should be able to pull pretty close to 100k then lol", -- [22]
						"/i 8%", -- [23]
						"/i yes", -- [24]
						"/i its sorta the MT", -- [25]
						"/i and if he leaves it WONT happen", -- [26]
						"/i oh one last side note", -- [27]
						"/i DONT STAND IN SHIT", -- [28]
						"/i especially red shit", -- [29]
						"/i it gives him rage", -- [30]
						"/i rage is bad", -- [31]
						"/i also it hurts", -- [32]
					},
				},
