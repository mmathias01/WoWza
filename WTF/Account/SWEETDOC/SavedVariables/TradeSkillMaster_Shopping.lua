...
TradeSkillMaster_ShoppingDB = {
	["global"] = {
		...
		["previousSearches"] = {
			"Bolt of Embersilk Cloth/exact/x9", -- [1]
			"Embersilk Cloth/exact/x45", -- [2]
			"Mogu Pumpkin/exact/x7", -- [3]
			"Mogu Pumpkin/exact/x25", -- [4]
			"Pink Turnip/exact/x49", -- [5]
			"Tiger Gourami/exact/x5", -- [6]
			"Green Cabbage/exact/x4", -- [7]
			"Green Cabbage/exact/x23", -- [8]
			"Redbelly Mandarin/exact/x4", -- [9]
			"Red Blossom Leek/exact/x1", -- [10]
			"Red Blossom Leek/exact/x25", -- [11]
			"White Turnip/exact/x25", -- [12]
			"Raw Crab Meat/exact/x2", -- [13]
			"Raw Crab Meat/exact/x5", -- [14]
			"Jewel Danio/exact/x3", -- [15]
			"Scallions/exact/x4", -- [16]
			"Scallions/exact/x24", -- [17]
			"Raw Turtle Meat/exact/x2", -- [18]
			"Raw Turtle Meat/exact/x5", -- [19]
			"Giant Mantis Shrimp/exact/x5", -- [20]
			"Krasarang Paddlefish/exact/x48", -- [21]
			"Witchberries/exact/x222", -- [22]
			"White Turnip/exact/x220", -- [23]
			"Redbelly Mandarin/exact/x8", -- [24]
			"Redbelly Mandarin/exact/x50", -- [25]
			"Raw Turtle Meat/exact/x22", -- [26]
			"Raw Crocolisk Belly/exact/x34", -- [27]
			"Raw Crab Meat/exact/x33", -- [28]
			"Red Blossom Leek/exact/x20", -- [29]
			"Red Blossom Leek/exact/x77", -- [30]
			"Red Blossom Leek/exact/x236", -- [31]
			"Mogu Pumpkin/exact/x100", -- [32]
			"Jade Squash/exact/x210", -- [33]
			"Green Cabbage/exact/x249", -- [34]
			"Giant Mantis Shrimp/exact/x41", -- [35]
			"Emperor Salmon/exact/x27", -- [36]
			"Emperor Salmon/exact/x48", -- [37]
			"Wildfowl Breast/exact/x2", -- [38]
			"Wildfowl Breast/exact/x39", -- [39]
			"Jade Squash/exact/x60", -- [40]
			"Striped Melon/exact/x64", -- [41]
			"Witchberries/exact/x22", -- [42]
			"Scallions/exact/x9", -- [43]
			"Scallions/exact/x62", -- [44]
			"Reef Octopus/exact/x2", -- [45]
			"Juicycrunch Carrot/exact/x16", -- [46]
			"Raw Turtle Meat/exact/x12", -- [47]
			"Raw Turtle Meat/exact/x15", -- [48]
			"Juicycrunch Carrot/exact/x5", -- [49]
			"shining", -- [50]
			"Iceweb Spider Silk/exact/x1", -- [51]
			"Crystallized Life/exact/x2", -- [52]
		},
		["appInfo"] = {
			["Default"] = {
			},
