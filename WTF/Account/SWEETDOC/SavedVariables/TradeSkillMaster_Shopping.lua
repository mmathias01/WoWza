...
TradeSkillMaster_ShoppingDB = {
	["global"] = {
		["previousSearches"] = {
			"Mogu Pumpkin/exact/x7", -- [1]
			"Mogu Pumpkin/exact/x25", -- [2]
			"Pink Turnip/exact/x49", -- [3]
			"Tiger Gourami/exact/x5", -- [4]
			"Green Cabbage/exact/x4", -- [5]
			"Green Cabbage/exact/x23", -- [6]
			"Redbelly Mandarin/exact/x4", -- [7]
			"Red Blossom Leek/exact/x1", -- [8]
			"Red Blossom Leek/exact/x25", -- [9]
			"White Turnip/exact/x25", -- [10]
			"Raw Crab Meat/exact/x2", -- [11]
			"Raw Crab Meat/exact/x5", -- [12]
			"Jewel Danio/exact/x3", -- [13]
			"Scallions/exact/x4", -- [14]
			"Scallions/exact/x24", -- [15]
			"Raw Turtle Meat/exact/x2", -- [16]
			"Raw Turtle Meat/exact/x5", -- [17]
			"Giant Mantis Shrimp/exact/x5", -- [18]
			"Krasarang Paddlefish/exact/x48", -- [19]
			"Witchberries/exact/x222", -- [20]
			"White Turnip/exact/x220", -- [21]
			"Redbelly Mandarin/exact/x8", -- [22]
			"Redbelly Mandarin/exact/x50", -- [23]
			"Raw Turtle Meat/exact/x22", -- [24]
			"Raw Crocolisk Belly/exact/x34", -- [25]
			"Raw Crab Meat/exact/x33", -- [26]
			"Red Blossom Leek/exact/x20", -- [27]
			"Red Blossom Leek/exact/x77", -- [28]
			"Red Blossom Leek/exact/x236", -- [29]
			"Mogu Pumpkin/exact/x100", -- [30]
			"Jade Squash/exact/x210", -- [31]
			"Green Cabbage/exact/x249", -- [32]
			"Giant Mantis Shrimp/exact/x41", -- [33]
			"Emperor Salmon/exact/x27", -- [34]
			"Emperor Salmon/exact/x48", -- [35]
			"Wildfowl Breast/exact/x2", -- [36]
			"Wildfowl Breast/exact/x39", -- [37]
			"Jade Squash/exact/x60", -- [38]
			"Striped Melon/exact/x64", -- [39]
			"Witchberries/exact/x22", -- [40]
			"Scallions/exact/x9", -- [41]
			"Scallions/exact/x62", -- [42]
			"Reef Octopus/exact/x2", -- [43]
			"Juicycrunch Carrot/exact/x16", -- [44]
			"Raw Turtle Meat/exact/x12", -- [45]
			"Raw Turtle Meat/exact/x15", -- [46]
			"Juicycrunch Carrot/exact/x5", -- [47]
			"shining", -- [48]
			"Iceweb Spider Silk/exact/x1", -- [49]
			"Crystallized Life/exact/x2", -- [50]
		},
		["appInfo"] = {
			["Default"] = {
			},
