...
TradeSkillMaster_ShoppingDB = {
	["global"] = {
		...
		["sidebarBtn"] = 2,
		["previousSearches"] = {
			"Silkweed/exact/x16", -- [1]
			"Green Tea Leaf/exact/x60", -- [2]
			"Snow Lily/exact/x9", -- [3]
			"Golden Lotus/exact/x15", -- [4]
			"Fool's Cap/exact/x5", -- [5]
			"Silkweed/exact/x1", -- [6]
			"kra", -- [7]
			"Snow Lily/exact/x19", -- [8]
			"Fool's Cap/exact/x9", -- [9]
			"Golden Lotus/exact/x10", -- [10]
			"Silkweed/exact/x40", -- [11]
		},
		["optionsTreeStatus"] = {
			["groups"] = {
				["1"] = true,
