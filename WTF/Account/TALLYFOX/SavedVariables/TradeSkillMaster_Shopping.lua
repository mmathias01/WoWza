...
TradeSkillMaster_ShoppingDB = {
	...
	["global"] = {
		["previousSearches"] = {
			"Silkweed/exact/x28", -- [1]
			"Silkweed/exact", -- [2]
			"Silkweed/exact/x16", -- [3]
			"Green Tea Leaf/exact/x60", -- [4]
			"Snow Lily/exact/x9", -- [5]
			"Golden Lotus/exact/x15", -- [6]
			"Fool's Cap/exact/x5", -- [7]
			"Silkweed/exact/x1", -- [8]
			"kra", -- [9]
			"Snow Lily/exact/x19", -- [10]
			"Fool's Cap/exact/x9", -- [11]
			"Golden Lotus/exact/x10", -- [12]
			"Silkweed/exact/x40", -- [13]
		},
		["appInfo"] = {
			["Default"] = {
