...
L["BE SURE TO SPELL THE NAME CORRECTLY!"] = "VERSICHERE DICH, DASS DER NAME RICHTIG GESCHRIEBEN IST!" -- Needs review
...
L["Expired: %s | %s"] = "Aubgelaufen: %s | %s" -- Needs review
...
L["Quick Send"] = "Schnelles Verschicken" -- Needs review
-- L["Relationships"] = ""
...
L["Send Disenchantable Greens to %s"] = "Schicke entzauberbare grüne Gegenständ an %s" -- Needs review
L["Send Excess Gold to Banker:"] = "Schicke überschüssiges Gold an Banker:" -- Needs review
L["Send Excess Gold to %s"] = "Schicke überschüssiges Gold an %s." -- Needs review
L["Sending..."] = "Verschicke..." -- Needs review
L["Send Items Individually"] = "Sende Items individuell."
L["Sends each unique item in a seperate mail."] = "Sende jedes einzigartige Item in einem separaten Brief."
L["Send %sx%d to %s - No COD"] = "Schicke %sx%d an %s - Keine Nachnahme" -- Needs review
L["Send %sx%d to %s - %s per Item COD"] = "Schicke %sx%d an %s - %s Nachnahme je Gegenstand" -- Needs review
...
L["%s to collect."] = "%s einzusammeln." -- Needs review
L["%s total gold collected!"] = "%s Gold insgessamt eingesammelt." -- Needs review
