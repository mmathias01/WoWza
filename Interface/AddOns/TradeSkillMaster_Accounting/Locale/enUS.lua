...
L["%s ago"] = true
L["Accounting has not yet collect enough information for this tab. This is likely due to not having recorded enough data points or not seeing any significant fluctuations (over 1k gold) in your gold on hand."] = true
...
L["Today"] = true
L["Top Buyers:"] = true
L["Top Expense by Gold:"] = true
L["Top Expense by Quantity:"] = true
L["Top Income by Gold:"] = true
L["Top Income by Quantity:"] = true
