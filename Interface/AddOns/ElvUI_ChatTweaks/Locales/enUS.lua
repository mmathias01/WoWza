...
L["Allows you to spam a message to General or Trade chat every X seconds.  Useful for guild recruitment or profession links."] = true
...
L["Channel Spam"] = true
L["Channel Spam has been |cff%s%s|r."] = true
L["Channel Spam is already running."] = true
L["Channel to output the messages to."] = true
...
L["No role was set because you have no specialization."] = true
L["NoTarget"] = true
L["None"] = true
L["Not Found"] = true
...
L["|cffff0000ERROR|r Both messages must be set in order to use the spam method |cffffff00%s|r"] = true
...
L["|cffffffffBlocked spam from |Hplayer:%s|h[%s]|h,|r |cfffe2ec8|Hspamfilter:%d:%s|h[Click to report!]|h|r"] = true
