...
local L = AceLocale:NewLocale("ElvUI_ChatTweaks", "ptBR", false)
...
L["Active Modules"] = "M\195\179dulos Ativos" -- Needs review
...
L["Adds an ElvUI datatext for this addon."] = "Adiciona um datatext ElvUI para esse addon" -- Needs review
L["Adds a timestamp to each line of text."] = "Adiciona hora para cada linha de texto" -- Needs review
...
\
"] = "Adicionar comandos de chat para limpar a janela do chat" -- Needs review
...
L["Add surrounding brackets to own charname in messages."] = "Adicionar colchetes envolvendo o nome do seu personagem nas mensagens" -- Needs review
...
L["After"] = "Depois" -- Needs review
L["Alchemy"] = "Alchemy" -- Requires localization
L["All"] = "All" -- Requires localization
L["All Modules"] = "Todos os m\195\179dulos" -- Needs review
...
\
|cffff0000Using another addon to do this will break this functionality.|r"] = "Permite que voc\195\170 mude as configura\195\167\195\181es de fonte padr\195\163o para os quadros de chat. \
|cffff0000Usando outro addon para fazer isso, anular\195\161 essa funcionalidade.|r" -- Needs review
...
L["Alt-click name to invite"] = "Alt-click nome para convidar" -- Needs review
L["Alternate"] = "Alternate" -- Requires localization
L["ALTERNATE"] = "ALTERNATE" -- Requires localization
L["Alternate command to kick someone from guild."] = "Comando alternativo para kickar algu\195\169m da guilda" -- Needs review
...
L["Are you sure you want to delete all your saved class/level data?"] = "Voc\195\170 tem certeza que quer deletar todos os dados salvos referentes as suas classes/n\195\173veis?" -- Needs review
...
L["Are you sure you want to reset the chat fonts to defaults?"] = "Voc\195\170 tem certeza que quer resetar as fontes do chat para o padr\195\163o?" -- Needs review
...
L["Automatically enables chat logging."] = "Ativa automaticamente o log do chat." -- Needs review
...
L["Automatic Chat Logging"] = "Grava\195\167\195\163o Automatica do Bate-papo" -- Needs review
...
L["Available Chat Command Arguments"] = "Argumentos de Comandos de Chat Dispon\195\173veis" -- Needs review
...
L[" |cffffff00%d|r Total Modules (|cff00ff00%d|r Enabled, |cffff0000%d|r Disabled)"] = " |cffffff00%d|r Total de M\195\179dulos (|cff00ff00%d|r Ativos, |cffff0000%d|r Inativos)" -- Needs review
...
L["Channel Colors"] = "Cores dos Canais" -- Needs review
...
L["Channel Sounds"] = "Sons dos Canais" -- Needs review
...
L["Character to use between the name and level"] = "Car\195\161cter para usar entre o nome e n\195\173vel" -- Needs review
L["Character to use for the left bracket"] = "Car\195\161cter para usar no colchete esquerdo" -- Needs review
L["Character to use for the right bracket"] = "Caracter para usar no colchete direito" -- Needs review
L["Chat"] = "Chat" -- Requires localization
L["Chat Events"] = "Chat Events" -- Requires localization
L["Chat Fonts"] = "Fote do Bate-papo" -- Needs review
...
L["ChatFrame %d"] = "QuadrodeChat %d" -- Needs review
L["Chat Frame Settings"] = "Configura\195\167\195\181es do quadro de chat" -- Needs review
...
L["Choose which chat frames display timestamps"] = "Escolha em quais quadros de chat mostrar\195\161 o hor\195\161rio" -- Needs review
L["Class"] = "Classe" -- Needs review
L["Clear all chat windows."] = "Limpar todas as janelas do chat" -- Needs review
L["Clear All Logs"] = "Clear All Logs" -- Requires localization
L["Clear Chat Commands"] = "Comandos de limpeza de chat" -- Needs review
L["Clear current chat."] = "Limpar o bate-papo atual" -- Needs review
...
L["Color own charname in messages."] = "Colorir o pr\195\179prio nome de personagem nas mensagens." -- Needs review
L["Color Player Names By..."] = "Colorir nomes de jogadores por..." -- Needs review
L["Color regular rolls by others."] = "Color regular rolls by others." -- Requires localization
L["Color Rolls"] = "Reguas de cores" -- Needs review
...
L["Color self in messages"] = "Colorir a si mesmo nas mensagens" -- Needs review
...
L["Color timestamps the same as the channel they appear in."] = "Colorir hor\195\161rio com a mesma cor do canal que elas aparecerem." -- Needs review
...
L["Command Help"] = "Ajuda de Comandos" -- Needs review
...
L["Creates a button to click that will return you to the bottom of the chat frame."] = "Cria um bot\195\163o para clicar que retornar\195\161 voc\195\170 ao fundo do quadro de chat." -- Needs review
...
L["Custom format (advanced)"] = "Formato padr\195\163o (avan\195\167ado)" -- Needs review
...
L["Datatext Display"] = "Display do Datatext" -- Needs review
L["Date"] = "Data" -- Needs review
...
L["Default font face for the chat frames."] = "Tipo padr\195\163o de fonte para os quadros de chat" -- Needs review
L["Default font outline for the chat frames."] = "Sombreamento de fonte padr\195\163o para os quadros de chat" -- Needs review
L["Default font size for the chat frames."] = "Tamanho de fonte padr\195\163o para os quadros de chat." -- Needs review
L["Default Name Color"] = "Cor de nome padr\195\163o" -- Needs review
L["Destroys all your saved class/level data"] = "Exclui todos os seus dados salvos de classe/n\195\173vel" -- Needs review
...
L["Disabled"] = "Inativo" -- Needs review
...
L["Editbox History"] = "Editar Historico" -- Needs review
L["ElvUI ChatTweaks"] = true -- Needs review
...
L["Emphasize Self"] = "Enfatizar a si mesmo" -- Needs review
...
L["Enter a custom time format. See http://www.lua.org/pil/22.1.html for a list of valid formatting symbols."] = "Entra um formato de tempo padr\195\163o. Veja: http://www.lua.org/pil/22.1.html para uma lista de simbolos de formata\195\167\195\163o v\195\161lida." -- Needs review
L["Exclude level display for max level characters"] = "Desconsidera mostrar n\195\173veis para personagens de n\195\173vel m\195\161ximo" -- Needs review
L["Exclude max levels"] = "Desconsidera n\195\173veis m\195\161ximos" -- Needs review
...
L["Font Face"] = "Tipo de fonte" -- Needs review
...
L["GKick Command"] = "Comando Gckick" -- Needs review
...
L["Group Say Command"] = "Comando de DIZER do grupo" -- Needs review
L["Guild"] = "Guilda" -- Needs review
L["Guild Channel"] = "Canal da Guilda" -- Needs review
L["Guild Chat"] = "Chat da Guilda" -- Needs review
...
L["HH:MM (12-hour)"] = "HH:MM (12-horas)" -- Needs review
L["HH:MM (24-hour)"] = "HH:MM (24-horas)" -- Needs review
L["HH:MM:SS (24-hour)"] = "HH:MM:SS (24-horas)" -- Needs review
L["HH:MM:SS AM (12-hour)"] = "HH:MM:SS AM (12-horas)" -- Needs review
...
L["Hunter"] = "Ca\195\167ador" -- Needs review
...
L["Include level"] = "Incluir n\195\173vel" -- Needs review
L["Include the player's level"] = "Inclui o n\195\173vel do jogador" -- Needs review
...
L["Invite Links"] = "Links de convite" -- Needs review
...
L["Keeps your channel colors by name rather than by number."] = "Mant\195\169m suas cores de canais por nome ao inv\195\169s de n\195\186mero." -- Needs review
...
L["Left Bracket"] = "Colchete esquerdo" -- Needs review
L["Left Channel"] = "Left Channel" -- Requires localization
L["Left Click"] = "Left Click" -- Requires localization
L["Lets you alt-click player names to invite them to your party."] = "Permite que voc\195\170 alt-click os nomes dos jogadores para convida-los para grupo." -- Needs review
L["Lets you set the justification of text in your chat frames."] = "Permite que voc\195\170 defina a justifica\195\167\195\163o do texto em seus quadros de chat." -- Needs review
...
L["Level Location"] = "Localiza\195\167\195\163o do n\195\173vel" -- Needs review
...
L["Loss Color"] = "Cor de perda" -- Needs review
...
L["Minimum DK Level"] = "N\195\173vel m\195\173nimo do DK" -- Needs review
L["Minimum Level"] = "N\195\173vel m\195\173nimo" -- Needs review
...
L["MONK"] = "MONK" -- Requires localization
L["Monster Emote"] = "Emote Monstro" -- Needs review
L["Monster Say"] = "Dizer Monstro" -- Needs review
...
L["No RealNames"] = "Sem nomes reais" -- Needs review
...
L["Officer Channel"] = "Canal dos Oficiais" -- Needs review
L["Officer Chat"] = "Chat dos Officers" -- Needs review
...
L["Opens configuration window."] = "Abre a janela de configura\195\167\195\163o." -- Needs review
L["Other Channels"] = "Outros Canais" -- Needs review
L["Ouput Frame"] = "Ouput Frame" -- Requires localization
L["Outline"] = "Sobrelinha" -- Needs review
...
L["Party Channel"] = "Canal do Grupo" -- Needs review
L["Party Leader"] = "Lider de grupo" -- Needs review
...
L["Place the level before or after the player's name."] = "Coloca o n\195\173vel antes ou depois do nome do jogador." -- Needs review
...
L["Player Level"] = "N\195\173vel do jogador" -- Needs review
L["Player level display options."] = "Op\195\167\195\181es de mostragem de n\195\173vel de jogadores" -- Needs review
L["Player Names"] = "Nomes dos jogadores" -- Needs review
...
L["Plays a sound, of your choosing (via LibSharedMedia-3.0), whenever a message is received in a given channel."] = "Toca um som, escolhido (via LibSharedMedia-3.0), assim que a mensagem for recebida em um determinado canal." -- Needs review
...
L["Prints module status."] = "Mostra o status do m\195\179dulo." -- Needs review
L["Print this again."] = "Mostra isso de novo." -- Needs review
L["Progress Updates"] = "Progress Updates" -- Requires localization
L["Provides a |cff00ff00/gkick|r command, as it should be."] = "Prov\195\170 um comando |cff00ff00/gkick|r, como deve ser." -- Needs review
...
L["Raid Channel"] = "Canal de Raide" -- Needs review
L["Raid Leader"] = "L\195\173der de Raide" -- Needs review
L["Raid Members"] = "Raid Members" -- Requires localization
L["Raid Warning"] = "Aviso de Raide" -- Needs review
L["Raid Warning Channel"] = "Canal de Avisos de Raide" -- Needs review
...
L["RealID Conversation"] = "Conversa RealID" -- Needs review
L["RealID Whisper"] = "Sussurro RealID" -- Needs review
...
L["Reset Data"] = "Reiniciar Dados" -- Needs review
...
L["Show ElvUI Chat Tweaks Config Window"] = "Mostrar a janela de configura\195\167\195\163o do addon ElvUi Chat Tweaks" -- Needs review
...
L["Time, in seconds, you want the search to continue before it ends."] = "Tempo, em segundos, que voc\195\170 quer que a busca continue antes que acabe" -- Needs review
...
L["Will automatically set your role based on your spec, when appropriate."] = "Ir\195\161 mostrar automaticamente sua fun\195\167\195\163o baseada na sua spec, quando apropriado." -- Needs review
