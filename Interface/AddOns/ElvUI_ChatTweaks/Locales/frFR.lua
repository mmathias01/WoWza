...
L["Adds a timestamp to each line of text."] = "Ajoute un horodatage \195\160 chaque ligne de texte." -- Needs review
...
\
"] = "Ajoute des commandes au tchat pour effacer la fen\195\170tre de tchat." -- Needs review
...
L["Add surrounding brackets to own charname in messages."] = "Ajoute des crochets autour de son propre nom de personnage dans les messages." -- Needs review
...
L["After"] = "Apr\195\168s" -- Needs review
...
\
|cffff0000Using another addon to do this will break this functionality.|r"] = "Permets de changer les param\195\168tres de la police par d\195\169faut dans les cadres du Tchat." -- Needs review
...
L["Alt-click name to invite"] = "alt-clic un nom pour inviter." -- Needs review
L["Alternate"] = "Alternate" -- Requires localization
L["ALTERNATE"] = "ALTERNATE" -- Requires localization
L["Alternate command to kick someone from guild."] = "Commande alternative pour expulser quelqu'un de la guilde." -- Needs review
...
L["Are you sure you want to delete all your saved class/level data?"] = "\195\138tes-vous certain de vouloir effacer toutes vos donn\195\169es classe/niveau ?" -- Needs review
...
L["Are you sure you want to reset the chat fonts to defaults?"] = "\195\138tes-vous sur de vouloir r\195\169initialiser les polices par d\195\169faut du tchat." -- Needs review
...
L["Automatically enables chat logging."] = "Activation de l'enregistrement automatique du tchat." -- Needs review
...
L["Battle.Net Options"] = "Options Battle.net" -- Needs review
L["Battle.Net Whisper"] = "Battle.Net Whisper" -- Requires localization
L["Before"] = "Avant" -- Needs review
...
L["Character to use between the name and level"] = "Caract\195\168re de s\195\169paration entre la classe et le niveau" -- Needs review
L["Character to use for the left bracket"] = "Caract\195\168re pour le crochet gauche" -- Needs review
L["Character to use for the right bracket"] = "Caract\195\168re pour le crochet droite" -- Needs review
...
L["Chat Frame "] = "Fen\195\170tre du chat" -- Needs review
L["Chat Frame %d"] = "Chat Frame %d" -- Requires localization
L["ChatFrame %d"] = "Cadre du tchat %d" -- Needs review
L["Chat Frame Settings"] = "Param\195\168tres des cadres du tchat" -- Needs review
...
L["Choose which chat frames display timestamps"] = "S\195\169lectionner les cadres affichant les horodatages" -- Needs review
L["Class"] = "Classe" -- Needs review
L["Clear all chat windows."] = "Effacer tous les cadres." -- Needs review
...
L["Color own charname in messages."] = "Coloriser son propre nom dans les messages." -- Needs review
...
L["Color Rolls"] = "Coloriser les jets de d\195\169" -- Needs review
...
L["Creates a button to click that will return you to the bottom of the chat frame."] = "Cr\195\169e un bouton qui vous permettra de revenir au bas de la fen\195\170tre de discussion." -- Needs review
...
L["Default font size for the chat frames."] = "Taille de la police par d\195\169faut pour les cadres de discussion." -- Needs review
L["Default Name Color"] = "Couleur du nom par d\195\169faut" -- Needs review
...
L["Emote"] = true -- Needs review
L["Emote Filter"] = "Emote Filter" -- Requires localization
L["Emphasize Self"] = "Mettre l'accent sur soi m\195\170me" -- Needs review
...
L["Enter a custom time format. See http://www.lua.org/pil/22.1.html for a list of valid formatting symbols."] = "Entrez un format horaire personnalis\195\169. Voir http://www.lua.org/pil/22.1.html pour une liste des symboles." -- Needs review
...
L["HH:MM (12-hour)"] = "HH:MM (12 heures)" -- Needs review
L["HH:MM (24-hour)"] = "HH:MM (24 heures)" -- Needs review
L["HH:MM:SS (24-hour)"] = "HH:MM:SS (24 heures)" -- Needs review
L["HH:MM:SS AM (12-hour)"] = "HH:MM:SS AM (12 heures)" -- Needs review
...
L["Include level"] = "Inclure le level" -- Needs review
L["Include the player's level"] = "Inclure le level du joueur" -- Needs review
...
L["Loss Color"] = "Couleur de perte" -- Needs review
L["lowercase"] = "lowercase" -- Requires localization
L["Mage"] = true -- Needs review
...
L["Priest"] = "Pr\195\170tre" -- Needs review
...
L["RealID Conversation"] = "Conversation Nom R\195\169el" -- Needs review
L["RealID Whisper"] = "Chuchotement Nom R\195\169el" -- Needs review
...
L["Reset"] = "Remettre \195\160 z\195\169ro" -- Needs review
...
L["Reset Data"] = "Remettre \195\160 z\195\169ro les donn\195\169es" -- Needs review
...
L["Scroll Reminder"] = "Rappel de d\195\169filement" -- Needs review
...
L["Separator"] = "S\195\169parateur" -- Needs review
...
\
|cff00ff00Pour d\195\169sactiver, mettre sur \"Aucun\"|r." -- Needs review
...
L["Text Justification"] = "Affichage texte \"justifi\195\169\"" -- Needs review
...
L["Thick Outline"] = "Bordure \195\169paisse" -- Needs review
...
L["Triggers"] = "D\195\169clencheurs" -- Needs review
...
L["Warlock"] = "D\195\169moniste" -- Needs review
