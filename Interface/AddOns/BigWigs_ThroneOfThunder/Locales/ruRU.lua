...
if L then
	...
	L.custom_off_ray_controllers_desc = "Использовать %s%s%s метки для обозначения людей, контролирующих лучи, требуется быть помощником или лидером."

	L.custom_off_parasite_marks = "Маркировка Темного паразита"
	L.custom_off_parasite_marks_desc = "Чтобы помочь лекарям, на людей с темным паразитом, будут поставлены метки %s%s%s, требуется быть помощником или лидером."
