...
if L then
	...
	L.unstablevitajumptarget_desc = "Предупреждает, если вы дальше всех от игрока с Нестабильной жизнью. Если всключено увеличение, запустится обратный отсчет, когда Нестабильная жизнь собирается перепрыгнуть с вас."
