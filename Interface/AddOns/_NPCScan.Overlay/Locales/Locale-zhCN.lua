...
private.L["BUTTON_TOOLTIP_LINE3"] = "|cffd6ff00Shift-点击：|r切换世界地图key" -- Needs review
...
private.L["MODULE_WORLDMAP_KEYTOGGLE_DESC"] = "切换路径Key。" -- Needs review
