...
private.L["CONFIG_ALPHA"] = "Альфа"
private.L["CONFIG_DESC"] = "Выбор карт, на которых будут показаны пути НИПов.  Большинство дополнений, модифицирующих карты, управляются функцией \"Карта мира\"."
private.L["CONFIG_SHOWALL"] = "Всегда показывать все пути."
private.L["CONFIG_SHOWALL_DESC"] = "Обычно, когда за НИПом не идет слежение, его путь не отображается на карте. Включите данную функцию, чтобы отображать все известные пути НИПов."
private.L["CONFIG_TITLE"] = "Наложение"
private.L["CONFIG_TITLE_STANDALONE"] = "_|cffCCCC88NPCScan|r.Overlay"
private.L["MODULE_ALPHAMAP3"] = "Дополнение AlphaMap3"
...
private.L["MODULE_RANGERING_DESC"] = "Заметка: Область слежения появляется только в зонах с отслеживаемыми НИПами."
...
private.L["MODULE_WORLDMAP_TOGGLE_DESC"] = "Переключить пути _|cffCCCC88NPCScan|r.Overlay для отслеживаемых НИПов."
