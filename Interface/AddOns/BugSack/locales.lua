...
L["All bugs"] = "Tutti i bug" -- Needs review
L["All stored bugs have been exterminated painfully."] = "Tutti i bug registrati sono stati eliminati." -- Needs review
L["autoDesc"] = "Apre automaticamente BugSack quando viene rilevato un errore, ma non se sei in combattimento." -- Needs review
L["Auto popup"] = "Auto popup" -- Needs review
L["|cffeda55fClick|r to open BugSack with the last bug. |cffeda55fShift-Click|r to reload the user interface. |cffeda55fAlt-Click|r to clear the sack."] = "|cffeda55fFai clic|r per aprire BugSack con l'ultimo bug. |cffeda55fFai Maiusc-Click|r per ricaricare gli addon. |cffeda55fFai Alt-Click|r per eliminare i bug." -- Needs review
L["|cffff4411BugSack requires the |r|cff44ff44!BugGrabber|r|cffff4411 addon, which you can download from the same place you got BugSack. Happy bug hunting!|r"] = "|cffff4411BugSack richiede l'addon |r|cff44ff44!BugGrabber|r|cffff4411, che puoi scaricare dallo stesso posto da cui hai scaricato BugSack.|r" -- Needs review
L["chatFrameDesc"] = "Scrive un avvertimento sulla chat quando un errore viene rilevato. Non scrive l'errore completo, solo un messaggio di attenzione!" -- Needs review
L["Chatframe output"] = "Output nella chat" -- Needs review
L["Current session"] = "Sessione corrente" -- Needs review
L["%d bugs have been sent to %s. He must have BugSack to be able to examine them."] = "%d bugs sono stati inviati a %s. Deve avere BugSack installato per poter esaminarli." -- Needs review
L["Failure to deserialize incoming data from %s."] = "Impossibile leggere i dati inviati da %s." -- Needs review
L["Filter addon mistakes"] = "Filtra errori addon" -- Needs review
L["filterDesc"] = "Scegli se BugSack deve trattare gli eventi ADDON_ACTION_BLOCKED e ADDON_ACTION_FORBIDDEN come bug oppure no. Se non capisci il significato di questa opzione, ignorala." -- Needs review
L["Font size"] = "Dimensione font" -- Needs review
L["Large"] = "Largo" -- Needs review
L["Limit"] = "Limite" -- Needs review
L["Local (%s)"] = "Locale (%s)" -- Needs review
L["Medium"] = "Medio" -- Needs review
L["minimapDesc"] = "Mostra l'icona di BugSack intorno alla minimappa." -- Needs review
L["Minimap icon"] = "Icona minimappa" -- Needs review
L["Mute"] = "Muto" -- Needs review
L["muteDesc"] = "Impedisce a BugSack di riprodurre alcun suono quando un bug viene rilevato, indipendentemente da cosa scegli nel menu qui sotto." -- Needs review
L["Next >"] = "Successivo >" -- Needs review
L["Player needs to be a valid name."] = "Il giocatore deve avere un nome valido." -- Needs review
L["< Previous"] = "< Precedente" -- Needs review
L["Previous session"] = "Sessione precedente" -- Needs review
L["saveDesc"] = "Salva i bug nel database. Se disattivato, i bug verranno eliminati alla fine della sessione." -- Needs review
L["Save errors"] = "Salva errori" -- Needs review
L["Send"] = "Invia" -- Needs review
L["Send all bugs from the currently viewed session (%d) in the sack to the player specified below."] = "Invia tutti i bug dalla sessione selezionata (%d) al giocatore specificato." -- Needs review
L["Send bugs"] = "Invia bug" -- Needs review
L["Sent by %s (%s)"] = "Inviati da %s (%s)" -- Needs review
L["Small"] = "Piccolo" -- Needs review
L["Sound"] = "Suono" -- Needs review
L["There's a bug in your soup!"] = "Un bug è stato rilevato!" -- Needs review
L["throttleDesc"] = "Alcune volte gli addon possono generare centinaia di bug al secondo, cosa che può bloccare il gioco. Abilitare questa opzione accelererà la cattura dei bug, in modo da impedire un blocco del gioco." -- Needs review
L["Today"] = "Oggi" -- Needs review
L["Toggle the minimap icon."] = "Attiva/Disattiva l'icona della minimappa." -- Needs review
L["wipeDesc"] = "Elimina tutti i bug dal database." -- Needs review
L["Wipe saved bugs"] = "Elimina bug salvati" -- Needs review
L["X-Large"] = "Molto largo" -- Needs review
L["You have no bugs, yay!"] = "Nessun bug rilevato!" -- Needs review
L["You've received %d bugs from %s."] = "Hai ricevuto %d bug da %s." -- Needs review
