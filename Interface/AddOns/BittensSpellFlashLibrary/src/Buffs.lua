...
if u.SkipOrUpgrade(c, "Buffs", 7) then
	return
end
...
local function hasAura(
	name, noGCD, matchSpellID, applied, checkFunction, durationFunction, target)
...
function c.HasBuff(name, noGCD, matchSpellID, applied)
	return hasAura(
		name, noGCD, matchSpellID, applied, s.Buff, s.BuffDuration, "player")
end
...
function c.HasMyDebuff(name, noGCD, matchSpellID, applied)
	return hasAura(
		name, noGCD, matchSpellID, applied, s.MyDebuff, s.MyDebuffDuration)
end
...
function c.HasDebuff(name, noGCD, matchSpellID, applied)
	return hasAura(
		name, noGCD, matchSpellID, applied, s.Debuff, s.DebuffDuration)
end
