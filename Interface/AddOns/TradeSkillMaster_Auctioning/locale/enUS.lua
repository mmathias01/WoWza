...
L["Below min price, posting at reset price."] = true
L["Bid percent"] = true
...
L["Minimum Price (aka Threshold)"] = true
...
L["NOTE: You can right click on any of the price settings below to show a window which will help with more advanced price settings such as using a % of another price source."] = true
L["New Operation"] = true
L["No Items to Reset"] = true
L["No posting."] = true
L["Normal Price (aka Fallback)"] = true
L["Normal Price:"] = true
...
L["Price to post at if there are no auctions up under your maximum price. This includes the case where there's none of an item on the AH."] = true
...
L["When Below Minimum (aka Reset Method)"] = true
L["Whitelist"] = true
