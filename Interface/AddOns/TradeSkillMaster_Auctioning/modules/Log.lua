...
local info = {
	post = {
		...
		postingFallback = {L["Posting at normal price."], GREEN},
		postingReset = {L["Below min price, posting at reset price."], GREEN},
	...
	cancel = {
		...
		atFallback = {L["At normal price and not undercut."], GREEN},
