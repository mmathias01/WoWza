...
local Dropdown = RazerNaga:CreateClass('Frame'); Dropdown:Hide()
RazerNaga.Dropdown = Dropdown

function Dropdown:New(name, parent, width)
	local f = self:Bind(CreateFrame('Frame', '$parent' .. name, parent, 'UIDropDownMenuTemplate'))
