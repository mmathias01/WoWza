...
L["Crafting will not queue any items affected by this operation with a profit below this value. As an example, a min profit of 'max(10g, 10% crafting)' would ensure atleast a 10g and 10% profit."] = true
...
L["Profession data not found for %s on %s. Logging into this player and opening the profression may solve this issue."] = true
...
L["Resets the position of the profession frame."] = true
...
L["The 'Gather' feature of TSM_Crafting requires TSM_ItemTracker to be installed/enabled in order to know where items are located. Please install/enable TSM_ItemTracker."] = true
L["Transform"] = true
L["TSM Groups"] = true
