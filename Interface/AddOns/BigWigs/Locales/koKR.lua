...
L["autoRoleDesc"] = [=[레이드에서 다른 사람들이 당신의 역할이 무엇인지 아는 것은 Big Wigs의 경고의 정확성을 높여줍니다. 이 옵션은 Big Wigs가 자동으로 당신의 역할을 업데이트하도록 합니다. 예를 들어 보스의 스킬들이 탱커에게 영향을 끼치지 않을 때, 몇몇 모듈은 플레이어가 탱커인지 체크할 것입니다.
|cffff4411이것은 역할별 특정 경고와 관련이 없으며, 이 옵션을 켜두도록 강력히 권장합니다!|r]=]
L["back"] = "<< 뒤로"
L["BAR"] = "바"
