...
L["Color the healing bar using the active status color instead of the health bar color."] = "Färbt die Heilleiste wenn sie aktiv ist, anstelle der Heilleistenfarbe" -- Needs review
L["Corner Size"] = "Eckengröße"
L["Darken the text color to match the inverted bar."] = "Den Text abdunkeln" -- Needs review
L["Enable Mouseover Highlight"] = "Rahmen Hervorhebung"
L["Enable right-click menu"] = "Rechts-Click-Menü einschalten" -- Needs review
...
L["Healing Bar Uses Status Color"] = "Heilleiste benutzt Farbe für Status" -- Needs review
...
L["Make the healing bar use the status color instead of the health bar color."] = "Lassen Sie die Lebensleiste die Status Farbe nutzen, Anstelle der Lebensbalken Farbe" -- Needs review
L["Never"] = "Nie"
L["None"] = "Kein Umriss"
...
L["Show the standard unit menu when right-clicking on a frame."] = "Zeige das standartdmäßige Einheitenmenü bei Rechtsklick auf einen Rahmen." -- Needs review
...
L["Color"] = "Farbe"
L["Color to use when the %s is above the high count threshold values."] = "Farbe, welche genutzt wird wenn %s über dem hohem Schwellenwert liegt." -- Needs review
L["Color to use when the %s is between the low and high count threshold values."] = "Farbe, welche genutzt wird wenn %s zwischen dem niedrigen und der hohem Schwellenwert liegt." -- Needs review
L["Color when %s is below the low threshold value."] = "Farbe, welche genutzt wird wenn %s unter dem niedrigen Schwellenwert liegt" -- Needs review
L["Curse"] = "Fluch"
...
L["High color"] = "Farbe für \"Hoch\"" -- Needs review
L["High threshold"] = "Hoher Schwellwert"
L["Low color"] = "Farbe für \"Niedrig\"" -- Needs review
L["Low threshold"] = "Niedriger Schwellwert"
L["Magic"] = "Magie"
L["Middle color"] = "Farbe für \"Mittig\"" -- Needs review
L["Pet"] = "Begleiter"
L["Poison"] = "Gift"
...
L["%s colors"] = "%s farben"
L["%s colors and threshold values."] = "%s Farben und Schwellenwerte" -- Needs review
L["Show duration"] = "Dauer anzeigen"
L["Show if mine"] = "Zeigen wenn es meiner ist"
L["Show if missing"] = "Zeigen wenn es fehlt"
L["Show on pets and vehicles."] = "auf Begleitern und Fahrzeugen anzeigen" -- Needs review
...
L["Casting color"] = "Farbe: Zauber" -- Needs review
L["Pending color"] = "Farbe: Abwarten" -- Needs review
L["RES"] = "Rezz" -- Needs review
L["Resurrection"] = "Wiederbelebung" -- Needs review
L["Show the status until the resurrection is accepted or expires, instead of only while it is being cast."] = "Zeigen den Status bis die Wiederbelebung akzeptiert wurde oder abgelaufen ist, anstatt es nur währen des zauberns zu tun." -- Needs review
L["Show until used"] = "Zeige bis es benutzt wurde," -- Needs review
L["Use this color for resurrections that are currently being cast."] = "Nutze diese Farbe für Wiederbelebungen die zur zur Zeit gezaubert werden." -- Needs review
L["Use this color for resurrections that have finished casting and are waiting to be accepted."] = "Nutze diese Farbe für Wiederbelebungen die fertige gezaubert wurden und darauf warten angenommen zuwerden." -- Needs review
