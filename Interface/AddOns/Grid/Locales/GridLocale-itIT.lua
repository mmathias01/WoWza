...
L["Right-Click to open the options menu."] = "Click-Destro per aprire il menù delle opzioni."
...
L["Show more detailed threat levels."] = "Mostra indici di minaccia più dettagliati."
L["Tank"] = "Difensore"
...
L["Add new Buff"] = "Aggiungi nuovo Beneficio"
L["Add new Debuff"] = "Aggiungi nuovo Maleficio"
L["Adds a new buff to the status module"] = "Aggiungi nuovo Beneficio al modulo degli status"
L["Adds a new debuff to the status module"] = "Aggiungi nuovo Maleficio al modulo degli status"
L["Auras"] = "Auree"
...
L["Delete (De)buff"] = "Elimina Bene(Male)ficio"
L["Deletes an existing debuff from the status module"] = "Elimina un mMaleficio esistente dal modulo degli stati"
L["Disease"] = "Malattia"
