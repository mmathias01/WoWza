...
Weitere Informationen zur Anpassung von Pawn findet ihr in der Hilfedatei (Readme.htm) die mit dieser Installation ausgeliefert wird.]=],
	...
	Stats = {
		...
		SpellPowerInfo = "Zaubermacht. Auf Caster-Waffen enthalten, jedoch nicht auf den meisten Rüstungen. Beinhaltet nicht die aus Intelligenz erhaltene Zaubermacht.",
