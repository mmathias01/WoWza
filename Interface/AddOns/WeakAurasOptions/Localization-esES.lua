...
L["Add a new display"] = "Añadir una nueva aura" -- Needs review
...
L["A group that dynamically controls the positioning of its children"] = "Un grupo que dinámicamente controla la posición de sus hijos" -- Needs review
L["Align"] = "Alinear"
...
L["Backdrop Style"] = "Estilo de fondo" -- Needs review
L["Background"] = "Fondo"
L["Background Color"] = "Color de Fondo"
L["Background Inset"] = "Intercalado de Fondo"
L["Background Offset"] = "Desplazamiento del Fondo" -- Needs review
L["Background Texture"] = "Textura del Fondo"
L["Bar Alpha"] = "Transparencia de la Barra"
L["Bar Color"] = "Color de la Barra"
L["Bar Color Settings"] = "Configuración de color de barra" -- Needs review
L["Bar in Front"] = "Barra en primer plano" -- Needs review
...
L["Border Inset"] = "Borde del recuadro" -- Needs review
L["Border Offset"] = "Desplazamiento de Borde"
L["Border Settings"] = "Configuración de bordes" -- Needs review
L["Border Size"] = "Tamaño del borde" -- Needs review
L["Border Style"] = "Estilo de borde" -- Needs review
L["Bottom Text"] = "Texto de Fondo"
L["Button Glow"] = "Resplandor del Botón"
L["Can be a name or a UID (e.g., party1). Only works on friendly players in your group."] = "Puede ser un nombre o un identificador de unidad(p.ej., party1). Solo funciona con personajes amistosos en tu grupo." -- Needs review
L["Cancel"] = "Cancelar"
L["Cat"] = "Gato"
L["Change the name of this display"] = "Cambiar el nombre del aura"
L["Channel Number"] = "Número de Canal"
L["Check On..."] = "Chequear..."
L["Choose"] = "Escoger" -- Needs review
L["Choose Trigger"] = "Escoger Disparador" -- Needs review
L["Choose whether the displayed icon is automatic or defined manually"] = "Escoge si quieres que el icono mostrado sea definido automáticamente o manualmente" -- Needs review
...
L["Font"] = "Fuente"
L["Font Flags"] = "Fuente de banderas" -- Needs review
L["Font Size"] = "Tamaño de fuente" -- Needs review
L["Font Type"] = "Tipo de fuente" -- Needs review
...
L["Stacks Settings"] = "Configuración de montones" -- Needs review
L["Stagger"] = "Tambaleo"
...
L["Text Settings"] = "Configuración de textos" -- Needs review
L["Texture"] = "Textura"
...
L["This region of type \"%s\" has no configuration options."] = "Esta región de tipo \"%s\" no tiene opciones de configuración." -- Needs review
L["Time in"] = "Contar En"
L["Timer"] = "Tiempo"
L["Timer Settings"] = "Configuración de temporizadores" -- Needs review
