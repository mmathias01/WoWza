...
private.L.NPCs["58336"] = "Кролик ярмарки Новолуния" -- Needs review
...
private.L.NPCs["60491"] = "Ша Злости" -- Needs review
...
private.L.NPCs["63509"] = "Улунь" -- Needs review
...
private.L.NPCs["64403"] = "Алани" -- Needs review
...
private.L.NPCs["69099"] = "Налак" -- Needs review
...
private.L.NPCs["71992"] = "Лунная волчица" -- Needs review
...
private.L["BLOCKFLIGHTSCAN"] = "Подавлять оповещения, когда на такси" -- Needs review
private.L["BLOCKFLIGHTSCAN_DESC"] = "Подавлять оповещения, когда игрок на такси. Важно: существо, тем не менее, будет кэшировано и NPCScan не сообщит о нем вновь, пока кэш не будет очищен." -- Needs review
private.L["BUTTON_FOUND"] = "Найден НИП!"
private.L["CACHED_FORMAT"] = "Следующие существа уже находятся в кэше: %s."
private.L["CACHED_LONG_FORMAT"] = "Следующие существа уже находятся в кэше. Попробуйте удалить их с помощью команды |cff808080“/npcscan”|r или очистив ваш кэш: %s." -- Needs review
private.L["CACHED_PET_RESTING_FORMAT"] = "Следующие питомцы попали в кэш пока вы отдыхали: %s." -- Needs review
private.L["CACHED_STABLED_FORMAT"] = "Следующие существа не могут быть найдены, потому что они приручены: %s"
private.L["CACHED_WORLD_FORMAT"] = "Следующие существа из %2$s уже находятся в кэше: %1$s." -- Needs review
...
private.L["CMD_CACHE_EMPTY"] = "В кэше никого нет." -- Needs review
private.L["CMD_HELP"] = "Команды |cff808080“/npcscan add <IDНИПа> <Название>”|r, |cff808080“/npcscan remove <IDНИПа или название>”|r, |cff808080“/npcscan cache”|r выводит список существ из кэша, и просто |cff808080“/npcscan”|r открывает меню настроек." -- Needs review
...
private.L["CONFIG_CACHEWARNINGS"] = "Выводить напоминания о кэше при входе/изменении мира" -- Needs review
private.L["CONFIG_CACHEWARNINGS_DESC"] = "Если НИП уже находиться в кэше, когда вы войдете\\смените мир, будет выведено напоминание о существах которых невозможно найти." -- Needs review
...
private.L["CONFIG_PRINTTIME"] = "Показ временных меток в окне чата"
private.L["CONFIG_PRINTTIME_DESC"] = "Добавляет текущее время ко всем выводимым сообщениям. Полезно при записи, когда НПЦ был найден."
private.L["CONFIG_TEST"] = "Тест сигнала" -- Needs review
private.L["CONFIG_TEST_DESC"] = "Имитирует оповещение |cff808080“Найден НИП!|r, которое информирует вас о том, кого именно надо искать." -- Needs review
private.L["CONFIG_TEST_HELP_FORMAT"] = "Нажмите на кнопку цели или используйте комбинацию клавиш для взятия в цель найденного существа.  Держите |cffffffff<%s>|r и перемещайте мышь, для перемещения кнопки цели.  Если Вы находитесь в бою когда НИП был найден, предупреждение появиться только после выхода из боя." -- Needs review
...
private.L["FOUND_TAMABLE_FORMAT"] = "Найдено: |cff808080“%s”|r!  |cffff2020(Примечание: приручаемое существо, возможно, это питомец охотника).|r" -- Needs review
private.L["FOUND_TAMABLE_WRONGZONE_FORMAT"] = "|cffff2020False alarm:|r Найдено приручаемое существо |cff808080“%s”|r в локации %s вместо %s (ID %d); Это определенно питомец охотника." -- Needs review
private.L["FOUND_UNIT_DEAD"] = "Найдено существо \"%s\", но оно уже мертво." -- Needs review
private.L["FOUND_UNIT_TAXI"] = "Во время перелета было найдено существо \"%s\" неподалеку от %d, %d в %s." -- Needs review
private.L["PRINT_FORMAT"] = "%s_|cffCCCC88NPCScan|r: %s"
private.L["RAREMOBS"] = "Редкие НИПы" -- Needs review
...
private.L["SEARCH_ADD_TAMABLE_FORMAT"] = "Заметка: |cff808080“%s”|r - приручаемое существо, при его обнаружении в качестве питомца охотника - будет ложная тревога." -- Needs review
private.L["SEARCH_CACHED"] = "В кэше" -- Needs review
...
private.L["SEARCH_ID_DESC"] = "ID НИПа для поиска.  Данное значение можно найти на таких сайтах как Wowhead.com."
private.L["SEARCH_IGNORE"] = "Удалить" -- Needs review
private.L["SEARCH_IGNORE_DESC"] = "Исключить выделенное существо из списка." -- Needs review
private.L["SEARCH_IGNORE_LIST"] = "Черный список" -- Needs review
private.L["SEARCH_IGNORE_LIST_DESC"] = "Список существ, которые NPCScan не будет отслеживать." -- Needs review
private.L["SEARCH_MAP"] = "Зона: "
private.L["SEARCH_NAME"] = "Название:"
private.L["SEARCH_NAME_DESC"] = "Ярлык НИПа. Он не обязан совпадать с реальным названием НИПа." -- Needs review
...
private.L["SEARCH_RAREMOBS_DESC"] = "Список редких НИПов по умолчанию." -- Needs review
private.L["SEARCH_REMOVE"] = "-"
private.L["SEARCH_TAMEBEAST_DECS"] = "Приручаемые редкие существа." -- Needs review
