...
L["Allows you to use data from http://wowuction.com in other TSM modules and view its various price points in your item tooltips."] = "Vous autorise a utiliser les données de http://wowuction.com dans les autres modules de tsm et de voir les différentes variations de prix dans votre aperçu d'objet." -- Needs review
